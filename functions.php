...
function ct_custom_scripts() {
	wp_enqueue_style( 'ct-custom-style', get_stylesheet_uri(), filemtime(untrailingslashit(get_template_directory(). '/style.css') ), 'all');
	wp_enqueue_style('ct-bootstrap-css', get_template_directory_uri() . '/assets/lib/css/bootstrap.min.css', [], false,'all');

	wp_enqueue_script( 'ct-custom-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'ct-bootstrap-bundle', get_template_directory_uri() . '/assets/lib/js/bootstrap.bundle.min.js', array(), false, true );
 ...
 * Theme Options page.
 */
require_once(get_template_directory() . '/inc/ct-theme-options.php');

/**
 * Function for creating breadcrumbs
 */
function get_breadcrumb() {
    echo '<a href="'.home_url().'" rel="nofollow" class="text-black-50">Home</a>';
    if (is_category() || is_single()) {
        ...
        echo '<span class="text-black-50">&nbsp;&nbsp;&#47;&nbsp;&nbsp;Search Results for... </span>';
        echo '"<em>';
